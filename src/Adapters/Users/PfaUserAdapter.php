...
class PfaUserAdapter extends AbstractAdapter
{
    public function getProvisioningUser(?PfaUser $pfaUser): ?ProvisioningUser
    {
        ...
        $scimUserEmails = new MultiValuedAttribute();
        $scimUserEmails->setValue($pfaUser->getUserName());
        $scimUserEmails->setPrimary(true);
        $provisioningUser->setEmails(array($scimUserEmails));
